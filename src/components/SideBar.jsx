...
const SideBar = observer(() => {
  ...
  const handleDownload = () => {
    ...
    data.groups[0].transparency = selectionStore.selectedStuff["Frame"]
      .transparency;
    ...
    data.groups[1].transparency = selectionStore.selectedStuff["Temple"]
      .transparency;

    data.groups[2].color = selectionStore.selectedStuff["Lenses"].color;
    data.groups[2].transparency = selectionStore.selectedStuff["Lenses"].transparency
  ...
  return (
    <div
      className={`w-full h-[555px] mx-5 bg-cover bg-center bg-no-repeat overflow-hidden border-1 border-gray-200 rounded-[10px] ${
